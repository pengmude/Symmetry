...
namespace YTCommon.Logger
{
    public partial class LogHelper : UserControl
    {
        ...
        public void Add(MsgLevel level, string logInfo, bool isDisplay = false)
        {
        ...
        public void Add(MsgLevel level, string logInfo, Exception ex, bool isDisplay = false)
        {
        ...
        public static void WriteLog(SingleLog singleLog)
        {
